# Case Study — Real-Estate Lead Automation (Demo #1)

**One-liner:** Built an AI automation that turns messy real-estate inquiry messages into clean CRM records + personalized draft replies in seconds — never inventing data it wasn't given, with all data staying in the client's own accounts.
...
**Cost:** ~fractions of a cent per lead at gpt-4o-mini — API cost negligible vs. the fee.
